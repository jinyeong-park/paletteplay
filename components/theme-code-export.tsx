  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Export {theme.name} Theme</DialogTitle>
          <DialogDescription>
            Choose your preferred framework or styling approach to implement this theme in your project.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="css" className="mt-4">
          <TabsList className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7">
            ...
            <TabsTrigger value="bulma">Bulma</TabsTrigger>
            <TabsTrigger value="foundation">Foundation</TabsTrigger>
            <TabsTrigger value="material-ui">Material UI</TabsTrigger>
            <TabsTrigger value="css-in-js">CSS-in-JS</TabsTrigger>
          </TabsList>
          ...
          <div className="mt-4">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              ...
              <li>Adjust variable names to match your existing naming conventions</li>
              <li>For frameworks, ensure you have the framework installed in your project</li>
