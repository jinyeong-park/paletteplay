      ...
      <BrandThemeProvider>
        <ThemeWrapper>
          <div className="flex min-h-screen flex-col">
            <header className="sticky top-0 z-50 w-full border-b backdrop-blur supports-[backdrop-filter]:bg-background/60">
              <div className="container flex h-16 items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-6">
                  ...
                  <Link href="#themes" className="text-sm font-medium hover:text-primary">
                    Themes
                  </Link>
            ...
            <main className="flex-1">
              ...
              <section className="container py-24 md:py-32 space-y-8">
                <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                  <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
                    Transform Your Design with <span className="theme-accent">AI</span>
                  </h1>
                  <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                    Create stunning web designs with AI-powered color palettes inspired by the world's most iconic tech
                    brands.
                  </p>
              ...
              <section id="features" className="container py-20 space-y-16">
                <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                  ...
                  <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                    Leverage the power of artificial intelligence to create unique, harmonious color palettes for your
                    projects.
                  </p>
                </div>
              ...
              {/* Themes Section */}
              <section id="themes" className="theme-secondary py-20">
                <div className="container space-y-16">
                  <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                    ...
                    <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                      Choose from 7 premium themes inspired by the world's most recognizable tech brands.
                    </p>
                  </div>
                    ...
                    <TabsContent value="airbnb" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#FF385C]/10 border-b">
                          <CardTitle className="text-[#FF385C]">Airbnb Theme</CardTitle>
                          <CardDescription>Clean, minimalist layout with warm, inviting colors</CardDescription>
                        </CardHeader>
                    ...
                    <TabsContent value="amazon" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#FF9900]/10 border-b">
                          <CardTitle className="text-[#FF9900]">Amazon Theme</CardTitle>
                          <CardDescription>Utilitarian design with high contrast readability</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <TabsContent value="docker" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#2496ED]/10 border-b">
                          <CardTitle className="text-[#2496ED]">Docker Theme</CardTitle>
                          <CardDescription>Technical, precise aesthetic with strong blue dominance</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <TabsContent value="stripe" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#635BFF]/10 border-b">
                          <CardTitle className="text-[#635BFF]">Stripe Theme</CardTitle>
                          <CardDescription>Elegant, professional design with soft color transitions</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <TabsContent value="notion" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#0070F3]/10 border-b">
                          <CardTitle className="text-[#0070F3]">Notion Theme</CardTitle>
                          <CardDescription>Minimalist workspace aesthetic with high readability</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <TabsContent value="github" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#0366D6]/10 border-b">
                          <CardTitle className="text-[#0366D6]">GitHub Theme</CardTitle>
                          <CardDescription>Developer-focused design with high-contrast readability</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
                    ...
                    <TabsContent value="apple" className="mt-6">
                      <Card>
                        <CardHeader className="bg-[#0071E3]/10 border-b">
                          <CardTitle className="text-[#0071E3]">Apple Theme</CardTitle>
                          <CardDescription>Minimalist, premium design with extensive white space</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6">
                          <div className="grid gap-4 md:grid-cols-4">
                            <div className="flex flex-col items-center gap-2">
              ...
              <section id="mood-themes" className="container py-20 space-y-16">
                <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                  ...
                  <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                    Explore color palettes designed to evoke specific moods and atmospheres for your projects.
                  </p>
                </div>
                <Tabs defaultValue="dreamy" className="mx-auto max-w-4xl">
                  ...
                  <TabsContent value="dreamy" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#B57EDC]/10 border-b">
                        <CardTitle className="text-[#B57EDC]">Dreamy Palette</CardTitle>
                        <CardDescription>Ethereal, soft aesthetic with gentle, floating sensation</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="tech" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#16213E]/10 border-b">
                        <CardTitle className="text-[#16213E]">Tech Minimalist Palette</CardTitle>
                        <CardDescription>Clean, precise design with modern technological feel</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="finance" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#2980B9]/10 border-b">
                        <CardTitle className="text-[#2980B9]">Finance Professional Palette</CardTitle>
                        <CardDescription>Trustworthy and stable with corporate reliability</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="interior" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#8C7B75]/10 border-b">
                        <CardTitle className="text-[#8C7B75]">Interior Design Palette</CardTitle>
                        <CardDescription>Organic and natural with sophisticated neutrals</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="creative" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#E74C3C]/10 border-b">
                        <CardTitle className="text-[#E74C3C]">Creative Arts Palette</CardTitle>
                        <CardDescription>Bold and expressive with energetic contrasts</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="wellness" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#4CAF50]/10 border-b">
                        <CardTitle className="text-[#4CAF50]">Wellness & Mindfulness Palette</CardTitle>
                        <CardDescription>Calming and restorative with natural organic feel</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="luxury" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#D4AF37]/10 border-b">
                        <CardTitle className="text-[#D4AF37]">Luxury & Elegance Palette</CardTitle>
                        <CardDescription>Opulent and refined with timeless sophistication</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
                  ...
                  <TabsContent value="startup" className="mt-6">
                    <Card>
                      <CardHeader className="bg-[#E74C3C]/10 border-b">
                        <CardTitle className="text-[#E74C3C]">Startup Energetic Palette</CardTitle>
                        <CardDescription>Dynamic and innovative with youthful energy</CardDescription>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <div className="grid gap-4 md:grid-cols-4">
                          <div className="flex flex-col items-center gap-2">
              ...
              <section id="pricing" className="container py-20 space-y-16">
                <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                  ...
                  <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
                    Choose the plan that's right for you and start creating beautiful designs today.
                  </p>
                </div>
              ...
              {/* FAQ Section */}
              <section id="faq" className="theme-secondary py-20">
                <div className="container space-y-16">
                  <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
                  ...
                  <div className="mx-auto grid max-w-4xl gap-6">
                    <Card>
                      <CardHeader>
                        <CardTitle>How does the AI color palette generator work?</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p>
                          Our AI color palette generator uses machine learning algorithms trained on thousands of
                          professional designs to analyze color harmony, contrast, and accessibility. It can extract
                          colors from your brand assets and suggest complementary palettes that align with your brand
                          identity.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      ...
                      <CardContent>
                        <p>
                          Yes! Free users can export basic CSS variables, while Premium users get access to advanced
                          export options including Tailwind config, CSS variables, SCSS, and design tokens for various
                          platforms.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      <CardHeader>
                        <CardTitle>Is my data secure when using the AI features?</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p>
                          Absolutely. We take data privacy seriously. Any brand assets or logos you upload for AI
                          analysis are processed securely and not stored permanently. Our AI processing is transparent
                          and complies with design ethics and privacy standards.
                        </p>
                      </CardContent>
                    </Card>
                    <Card>
                      ...
                      <CardContent>
                        <p>
                          Yes, you can upgrade from Free to Premium at any time. If you need to downgrade, you can do so
                          at the end of your billing cycle. Your custom themes and settings will be saved for 30 days if
                          you decide to upgrade again.
                        </p>
                      </CardContent>
                    </Card>
                  </div>
                ...
                <div className="mx-auto max-w-4xl rounded-lg theme-accent-bg p-8 text-white md:p-12">
                  <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                    <div className="space-y-4">
                      <h2 className="text-3xl font-bold tracking-tight">Ready to transform your design?</h2>
                      <p className="text-white/80">
                        Get started with PalettePlay today and unlock the power of AI-driven design.
                      </p>
                    </div>
            ...
            <footer className="border-t theme-secondary">
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI-powered design themes and color palettes for modern web applications.
                    </p>
                  </div>
                  <div>
